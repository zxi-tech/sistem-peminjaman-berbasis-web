                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input type="text" value={data.nip} onChange={(e) => setData('nip', e.target.value)} required className="w-full bg-[#F9FAFB] border border-gray-200 text-gray-800 rounded-lg px-3.5 py-2 text-xs outline-none focus:bg-white focus:ring-2 focus:ring-[#00A651]/20 focus:border-[#00A651] transition-all placeholder-gray-400 font-medium" placeholder="Contoh: 703703" />
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input type="text" value={data.name} onChange={(e) => setData('name', e.target.value)} required className="w-full bg-[#F9FAFB] border border-gray-200 text-gray-800 rounded-lg px-3.5 py-2 text-xs outline-none focus:bg-white focus:ring-2 focus:ring-[#00A651]/20 focus:border-[#00A651] transition-all placeholder-gray-400 font-medium" placeholder="Nama sesuai KTP/ID Card" />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input type="email" value={data.email} onChange={(e) => setData('email', e.target.value)} required className="w-full bg-[#F9FAFB] border border-gray-200 text-gray-800 rounded-lg px-3.5 py-2 text-xs outline-none focus:bg-white focus:ring-2 focus:ring-[#00A651]/20 focus:border-[#00A651] transition-all placeholder-gray-400 font-medium" placeholder="nama@pertamina.com" />
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                {/* Menggunakan handlePhoneChange agar huruf otomatis ditolak */}
                                <input type="tel" value={data.phone} onChange={handlePhoneChange} required className="w-full bg-[#F9FAFB] border border-gray-200 text-gray-800 rounded-lg px-3.5 py-2 text-xs outline-none focus:bg-white focus:ring-2 focus:ring-[#00A651]/20 focus:border-[#00A651] transition-all placeholder-gray-400 font-medium" placeholder="0812..." />
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <select value={data.department} onChange={(e) => setData('department', e.target.value)} required className="w-full bg-[#F9FAFB] border border-gray-200 text-gray-600 rounded-lg px-3.5 py-2 text-xs outline-none focus:bg-white focus:ring-2 focus:ring-[#00A651]/20 focus:border-[#00A651] transition-all cursor-pointer font-medium appearance-none">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1.5 relative">
                                ...
                                <div className="relative">
                                    {/* pr-10 agar teks yang diketik tidak menabrak ikon mata */}
                                    <input
