...
export default function Create({ auth, items }) {
    ...
    // Data dummy hanya akan muncul jika database barang KOSONG
    ...
    // PERBAIKAN LOGIKA AGAR TIDAK CRASH SAAT MENGETIK ANGKA
        ...
        <>
            ...
            <div className="min-h-screen bg-[#F8FAFC] font-sans pb-20 text-gray-800 selection:bg-[#00A651] selection:text-white">
                ...
                <main className="max-w-7xl mx-auto px-4 sm:px-6 mt-10">
                    ...
                    {/* BLOK NOTIFIKASI ERROR FLAS / SERVER */}
                        ...
                        <div className="lg:col-span-8 space-y-8">
                            <div className="bg-white rounded-[20px] shadow-sm border border-gray-200 overflow-hidden">
                                ...
                                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Tanggal Pinjam *</label>
                                        <input type="date" required value={data.start_date} onChange={(e) => setData('start_date', e.target.value)} className={`w-full bg-white border ${errors.start_date ? 'border-red-500 ring-2 ring-red-200' : 'border-gray-300'} text-gray-900 rounded-xl px-4 py-2.5 text-sm font-medium outline-none focus:ring-2 focus:ring-[#00A651]/20 focus:border-[#00A651] transition-all`} />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Tanggal Kembali *</label>
                                        <input type="date" required value={data.end_date} onChange={(e) => setData('end_date', e.target.value)} className={`w-full bg-white border ${errors.end_date ? 'border-red-500 ring-2 ring-red-200' : 'border-gray-300'} text-gray-900 rounded-xl px-4 py-2.5 text-sm font-medium outline-none focus:ring-2 focus:ring-[#00A651]/20 focus:border-[#00A651] transition-all`} />
                                    </div>
                                    <div className="md:col-span-2">
                                        <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Tujuan Keperluan *</label>
                                        <textarea rows="3" required value={data.purpose} onChange={(e) => setData('purpose', e.target.value)} className={`w-full bg-white border ${errors.purpose ? 'border-red-500 ring-2 ring-red-200' : 'border-gray-300'} text-gray-900 rounded-xl px-4 py-3 text-sm font-medium outline-none resize-none focus:ring-2 focus:ring-[#00A651]/20 focus:border-[#00A651] transition-all`} placeholder="Jelaskan secara singkat untuk keperluan apa APD ini dipinjam..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="sticky top-24 space-y-6">
                                <div className="bg-white rounded-[20px] shadow-sm border border-[#00A651]/20 overflow-hidden flex flex-col">
                                    ...
                                    <div className="p-6">
                                        ...
                                        {/* HAPUS 'disabled' JIKA TOTAL 0 AGAR ALERT BISA MUNCUL SAAT DIKLIK! */}
                                        <button type="submit" disabled={processing} className={`w-full py-3.5 rounded-full text-sm font-extrabold shadow-md transition-all flex justify-center items-center gap-2 transform hover:-translate-y-0.5 ${processing ? 'bg-gray-400 cursor-not-allowed shadow-none' : 'bg-[#00A651] hover:bg-[#008c44] text-white hover:shadow-lg'}`}>
